...
app.post('/formulario', (req, res) => {
  ...
  const { nome_cliente, email_cliente, senha_cliente, cpf_cliente, dataNasc_cliente, telefone_cliente, endereco_cliente } = req.body;
  ...
  connection.query(query, [nome_cliente, email_cliente, senha_cliente, cpf_cliente, dataNasc_cliente, telefone_cliente, endereco_cliente], (err, results) => {
    if (err) {
